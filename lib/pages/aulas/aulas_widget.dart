...
class _AulasWidgetState extends State<AulasWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AulasRecord>>(
      stream: queryAulasRecord(
        queryBuilder: (aulasRecord) => aulasRecord.orderBy('origem'),
      ),
      builder: (context, snapshot) {
        ...
        List<AulasRecord> aulasAulasRecordList = snapshot.data!;
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    aulasAulasRecordList.length.toString(),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                            ...
                            Builder(
                              builder: (context) {
                                final aulas = aulasAulasRecordList.toList();
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, aulasIndex) {
                                    final aulasItem = aulas[aulasIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 30.0, 0.0, 0.0),
                                      child: Column(
